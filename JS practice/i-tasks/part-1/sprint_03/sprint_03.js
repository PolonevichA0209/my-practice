...
let out110Html = document.querySelector('.out-110').innerHTML;
let out111 = document.querySelector('.out-111');
out111.innerHTML = out110Html;
// Task 12
...
let out120Html = document.querySelector('.out-120').innerHTML;
document.querySelector('.out-121').innerHTML = out120Html;
...
ul19.innerHTML += f02;
ul19.innerHTML += f03;
/* Вариант 2 через шаблонную строку
ul19.innerHTML = `
${f01}
${f02}
${f03}
