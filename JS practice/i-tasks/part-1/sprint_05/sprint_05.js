...
function t01() {
    ...
    //document.querySelector('.out-1').textContent = i1Val;
...
function t08() {
    const i8Val = document.querySelector('.i-8').value;
    document.querySelector('.p-8').value = i8Val;
    document.querySelector('.out-8').textContent = i8Val;
}
...
function t10() {
    ...
    const i10Val = document.querySelector('.i-10').value;
    out10.textContent = i10Val;
    out10.style.backgroundColor = i10Val;
}
...
function t13() {
    //При таком варианте получает все текстовые значения из option и выводит их на страницу.
    //document.querySelector('.out-13').textContent = document.querySelector('.s-13').textContent;

    // Единственное что пришло в голову.
    const out13 = document.querySelector('.out-13');
    const s13Opt = document.querySelectorAll('.s-13 option');
    s13Opt.forEach((elem) => {
        if (elem.selected) {
            out13.textContent = elem.textContent;
        }
    })
}
...
function t16() {
    document.querySelector('.s-162').value = document.querySelector('.s-161').value;
}
