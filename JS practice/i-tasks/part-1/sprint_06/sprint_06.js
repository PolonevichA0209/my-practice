...
function t01() {
    const i1Val = +document.querySelector('.i-1').value;
    if (i1Val > 1500) {
...
function t02() {
    ...
    const i2Val = +document.querySelector('.i-2').value;
    if (i2Val > 1500) {
        out2.textContent = 1;
    }
    else {
...
function t03() {
    const i3Val = +document.querySelector('.i-3').value;
...
function t06() {
    ...
    const i6Val = document.querySelector('.i-6').value;
    (i6Val.length > 10) ? out6.textContent = true : out6.textContent = false;
}
...
function t07() {
    ...
    (num1 > num2 || num1 === num2) ? out7.textContent = num1 : out7.textContent = num2;
...
function t08() {
    let year = +document.querySelector('.i-8').value;
    let currenYear = 2024;
...
function t09() {
    ...
    if (num >= 1 && num <= 36) {
        out9.textContent = 1;
    } else if (num >= 37 && num <= 87) {
        out9.textContent = 2;
    } else if (num >= 88 && num <= 110) {
        out9.textContent = 3;
    } else {
        out9.textContent = 0;
    }
...
function t10() {
    const range = +document.querySelector('.r-10').value;
    const out10 = document.querySelector('.out-10');
    if (range >= 20 && range <= 30) {
        out10.textContent = 'cold';
    } else if (range >= 31 && range <= 50) {
...
function t14() {
    document.querySelector('.out-14').textContent = (g14 === 2000) ? 1 : 0;
}
...
function t15() {
    const prod = document.querySelector('.s-15').value;
    console.log(prod);
    out15.textContent = (prod === 'true') ? 'sale' : '';
}
...
function t16() {
    let text = document.querySelector('.i-16').value;
    out16.textContent = text;
    if (text.length < 5) {
...
function t18() {
    const val = document.querySelector('.s-18').value;
    switch (val) {
        case '1':
...
function t19() {
    out19.textContent = (document.querySelector('.ch-19').checked) ? 1 : 0;
}
...
function t20() {
    const check = document.querySelector('.ch-20');
    out20.textContent = (check.checked) ? check.value : 0;
}
