...
function t01() {
    out1.textContent = html.getAttribute('lang');
}
...
function t03() {
    out3.textContent = document.querySelector('#d-3').textContent;
}
...
function t04() {
    const d = document.querySelector('#d-3');
    d.setAttribute('id', 'd-4');
    out4.textContent = d.textContent;
}
