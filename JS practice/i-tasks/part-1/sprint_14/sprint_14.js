...
const t12 = temperature => {
    if (temperature >= 0 && temperature <= 20) {
        ...
        return 'hot';
    } else if (temperature >= 51 && temperature <= 100) {
        return 'very hot';
    }
}
...
const t14 = num => (num % 2 === 0) ? true : false;
...
const t15 = cl => {
    elem = document.querySelector(cl);
    if (elem !== null) {
        return true;
    } else {
        return false;
...
document.querySelector('.b-15').onclick = () => {
    document.querySelector('.out-15').textContent = t15('.out-1555555');
}
...
const t16 = str => (str.includes('@')) ? true : false;
