...
const t02 = () => {
    document.querySelector('.out-2').style.backgroundColor = 'orange';
}
...
const t03 = () => {
    document.querySelector('.out-3').textContent = 'mouseup';
}
...
const t04 = () => {
    document.querySelector('.out-4').textContent = 'mousedown';
}
...
const t05 = () => {
    document.querySelector('.out-5').textContent = 'mousedown';
}
...
const t07 = () => {
    document.querySelector('.block-7').addEventListener('contextmenu', (event) => {
...
const t09 = () => {
    block9.style.transform += 'rotate(' + 15 + 'deg)';
}
...
function t12() {
    document.querySelector('.out-12').textContent = document.querySelector('.i-12').value;
}
...
const t14 = () => {
    document.querySelector('.out-14').textContent = document.querySelector('.i-14').value;
}
...
const t18 = () => {
    const tab = document.querySelector('[tabindex = "18"]');
    tab.focus();
}
...
document.querySelector('.i-19').addEventListener('click', t19);
