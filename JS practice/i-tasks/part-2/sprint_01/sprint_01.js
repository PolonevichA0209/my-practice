...
const t14 = () => {
    for (let i = 0; i < arr_14.length; i++) {
        document.querySelector('.out-14').textContent += `${arr_14[i]}_`;
    }
}
...
const t15 = () => {
    for (let i = 0; i < arr_15.length; i++) {
        if (arr_15[i] % 2 === 0) {
            document.querySelector('.out-15').textContent += `${arr_15[i]}_`;
        }
    }
}
...
const t16 = () => {
    for (let i = 0; i < arr_16.length; i++) {
        if (i % 2 === 0) {
            document.querySelector('.out-16').textContent += `${arr_16[i]}_`;
        }
    }
}
...
const t17 = () => {
    for (let i = arr_17.length - 1; i >= 0; i--) {
        document.querySelector('.out-17').textContent += `${arr_17[i]}_`;
    }
}
...
const t18 = () => {
    for (let i = 0; i < arr_18.length; i++) {
        if (i === 0 || i === 1 || i === 5 || i === 7) {
            document.querySelector('.out-18').textContent += `${arr_18[i]} `;
        }
    }
}
...
const t21 = () => {
    const val = document.querySelector('.i-21').value;
    if (arr_21.length < 10) {
        arr_21.push(val);
    }
