...
const t04 = () => {
    arr_04.filter((elem, index) => {
        if (index % 2 === 0) {
            out4.textContent += `${index}_`;
        }
    })
}
...
const t11 = () => {
    const text = document.querySelector('.i-11').value;
    arr_11 = [text, ...arr_11]
...
const t14 = () => {
    const val = +document.querySelector('.i-14').value;
    document.querySelector('.out-14').textContent = arr_14.indexOf(val);
}
...
const t15 = () => {
    const val = +document.querySelector('.i-15').value;
    document.querySelector('.out-15').textContent = (arr_15.includes(val)) ? arr_15.indexOf(val) : false;
}
...
const t18 = () => {
    document.querySelector('.out-18').textContent = arr_18.map(t888).join(' ');
}
