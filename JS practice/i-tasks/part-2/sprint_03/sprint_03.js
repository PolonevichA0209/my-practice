...
const t08 = (arr1) => {
    const arrReverse = arr1.slice().reverse();
    return arrReverse.find(elem => elem > 10 && elem < 13);
};
...
const t10 = (arr, val) => {
    return arr.findLastIndex(item => item == val);
};
